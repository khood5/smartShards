                ...
                for line in logLines:
                    ...
                    if submit is not None:
                        ...
                        if tx_val == 999 and tx_id % SAMPLE_MOD == 0:
                            print("submit")
                            print(tx_key, tx_val, tx_time)
                            resultsSet.update({tx_key: (tx_time)})
                    ...
                    if confirm is not None:
                        ...
                        if tx_val == 999 and resultsSet.get(tx_key) is not None and tx_id % SAMPLE_MOD == 0:
                            print("confirm")
                            print(tx_key, tx_val, tx_time)
                            linkLines.append((resultsSet.get(tx_key), tx_time))
